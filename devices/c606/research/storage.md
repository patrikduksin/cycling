...
The host investigator [mmc.py](../../../tools/devtools/src/cycling_devtools/device/mmc.py) validates each sector as
...
`mise run flash` workflow. The host [mmc_maintenance.py](../../../tools/devtools/src/cycling_devtools/device/mmc_maintenance.py)
...
The offline [mmc_partition.py](../../../tools/devtools/src/cycling_devtools/device/mmc_partition.py) takes that backup
...
The [partition executor](../../../tools/devtools/src/cycling_devtools/device/mmc_partition_apply.py) defaults to
...
and protected application limit are owned by [firmware.py](../../../tools/devtools/src/cycling_devtools/device/firmware.py)
