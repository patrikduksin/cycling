//! Passive C606 companion sensor reports recovered from N21 1.956 and N22 1.902.
//! The installed parts and motion scaling remain unknown. No sensor commands,
//! calibration writes, altitude conversion or physical axis mapping live here.

use crate::capabilities::{Observation, observation};
...
mod tests {
    use super::*;
    use crate::companion::{Decoder, crc16, feed_frames};
