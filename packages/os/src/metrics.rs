...
pub struct Snapshot {
    ...
    pub ride_recording: crate::ride_log::Status,
    pub ride_source: Option<crate::ride_log::Source>,
    pub recording_active_ms: u64,
    pub recorded_samples: u32,
    pub recording_dropped: u32,
    pub recorded_rides: u16,
