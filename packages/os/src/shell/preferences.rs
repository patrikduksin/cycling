...
pub struct Settings {
    ...
    pub wifi: Option<crate::connectivity::WifiConfig>,
    pub ble: Option<crate::ble_transport::Selection>,
    pub ble_profile: u8,
}
        ...
        Some(mut settings) => {
            ...
            match payload[15] {
                ...
                1 | 2 => {
                    ...
                    settings.wifi = crate::connectivity::WifiConfig::new(
                        &payload[17..17 + n],
                        &payload[50..50 + m],
                        payload[15] == 2,
                    );
            ...
            match payload[113] {
                ...
                1 => {
                    ...
                    let Some(name) = crate::connectivity::Text::new(&payload[116..116 + n]) else {
                        return malformed();
                    };
                    let address =
                    ...
                    settings.ble = Some(crate::ble_transport::Selection {
                        name,
                        address,
...
mod tests {
    ...
    fn connectivity_round_trips_and_all_preference_updates_preserve_it() {
        ...
        settings.wifi = Some(
            crate::connectivity::WifiConfig::new(b"Owned test", b"test-password", true).unwrap(),
        );
        settings.ble = Some(crate::ble_transport::Selection {
            name: crate::connectivity::Text::new(b"Owned fixture").unwrap(),
