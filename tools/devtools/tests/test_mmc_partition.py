...
import cycling_devtools.device.mmc_partition as part
import cycling_devtools.device.mmc_maintenance as maintenance
from cycling_devtools.device.mmc_maintenance import crc
